...
class Factory:
    ...
    def draw_gantt(self, save = None):
        ...
        plt.xticks(np.arange(0, self.env.now+1, 20))
        plt.ylabel("Machine")
...
if __name__ == '__main__':
    ...
    #parameter
    job_info = pd.read_excel("job_information.xlsx")
    PT_table = pd.read_excel("PT_table.xlsx")
    ST_table = pd.read_excel("ST_table.xlsx")
    ME_table = pd.read_excel("ME_table.xlsx")
    DP_rule = "MST"
